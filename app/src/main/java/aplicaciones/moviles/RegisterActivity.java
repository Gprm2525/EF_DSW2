        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!pwd.equals(cnfPwd)) {
                    Toast.makeText(RegisterActivity.this, "Por favor, compruebe que ambos tengan la misma contraseña...", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(userName) && TextUtils.isEmpty(pwd) && TextUtils.isEmpty(cnfPwd)) {
                    //checking if the text fields are empty or not.
                    Toast.makeText(RegisterActivity.this, "Por favor, colocar las credenciales...", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    mAuth.createUserWithEmailAndPassword(userName, pwd).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                loadingPB.setVisibility(View.GONE);
                                Toast.makeText(RegisterActivity.this, "Error sl registrar al usuario...", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
