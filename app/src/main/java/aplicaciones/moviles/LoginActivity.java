...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //add music to app
        MediaPlayer mp=MediaPlayer.create(this,R.raw.bosanova);
        mp.start();
        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email) && TextUtils.isEmpty(password)) {
                    Toast.makeText(LoginActivity.this, "Ingresar sus credenciales...", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            loadingPB.setVisibility(View.GONE);
                            Toast.makeText(LoginActivity.this, "Por favor, colocar las credenciales validas...", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
